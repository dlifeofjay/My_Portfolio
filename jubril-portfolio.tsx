...
import { Brain, Database, TrendingUp, Mail, Linkedin, Github, Zap, Target, Menu, X, Code2, LineChart, Sparkles } from 'lucide-react';
...
export default function Portfolio() {
  ...
  const skills = {
    ...
    "Programming & Tools": ["Python", "SQL", "Git", "Scikit-learn", "TensorFlow", "XGBoost", "Pandas", "NumPy"],
